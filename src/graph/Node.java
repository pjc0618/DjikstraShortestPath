...
public class Node implements GraphElement {
    ...
    /** Used when viewing this graph as a directed graph.
    ...
    /** Used when viewing this graph as a directed graph.
     * Return a list of neighbors of this node.
     * Suppose edge e is attached to this node. If this
     * node is the source of e, the other node is the sink
     * and is returned. */
    public List<Node> directedNeightbors() {
